...
/* ═══════════════════════════════════════════════════════════════
   ...
   Save as: hirelens-frontend/src/pages/LandingPage.tsx
   ═══════════════════════════════════════════════════════════════ */
      ...
      >
        <motion.div variants={fadeUp}>
          <span className="sf-badge sf-badge-cyan" style={{ marginBottom: 24, display: "inline-flex" }}>
            <span style={{ width: 6, height: 6, borderRadius: "50%", background: "var(--sf-accent-primary)", animation: "pulse 2s infinite" }} />
            NOW IN BETA
          </span>
        </motion.div>
      ...
      <motion.div initial="hidden" animate={isInView ? "visible" : "hidden"} variants={stagger} style={{ maxWidth: 880, margin: "0 auto" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(340px, 1fr))", gap: 24 }}>
          ...
          <motion.div variants={fadeUp} style={{
            ...
            <a href="/login" className="sf-btn-primary" style={{ display: "block", textAlign: "center", textDecoration: "none", width: "100%" }}>
              Start Pro — $49/mo →
            </a>
