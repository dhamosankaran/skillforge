...
| B-110 | (no spec — this regen) | B-110 ✅ | `<this-slice>` | This CR full regen at HEAD `ac0466c`. All 13 sections re-anchored. R14 exception (a) — regenerated audit artifact, no test runs. Two-commit pattern (regen + SHA backfill replacing `<this-slice>` placeholders). |
