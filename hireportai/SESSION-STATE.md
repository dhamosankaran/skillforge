...
| Field | Value |
|-------|-------|
| **HEAD commit** | `ebef7da` (P5-S22-WALL-b; prev `d235a50` LD-001 amendment) |
| **Branch** | `main` |
| **CODE-REALITY.md sha (repo)** | `f09be80` (generated 2026-04-19) — **STALE** (HEAD advanced past; regenerate before next plan-level prompt) |
...
| **Last hand-edit** | 2026-04-20 — P5-S22-WALL-b shipped; LD-001 enforced in code |
