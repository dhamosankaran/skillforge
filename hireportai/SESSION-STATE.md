...
- Update `AGENTS.md` Frontend Routes table to add the `/onboarding/persona` row (spec #34 §Files Touched → Docs + state). Not a blocker; can be folded into the next AGENTS.md touch.
